...
import Agendamento from '@sellet/core/src/agendamento/model/Agendamento';
import RepositorioAgendamento from '@sellet/core/src/agendamento/provider/RepositorioAgendamento';
